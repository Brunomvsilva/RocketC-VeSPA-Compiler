...
- [Constant Folding Optimization](#constant-folding-optimization)
- [VeSPA ABI – Application Binary Interface](#vespa-abi--application-binary-interface)
- [Code Generation](#code-generation)
  - [Initialization Code](#initialization-code)
  - [Multiplication and Division Code Generation](#multiplication-and-division-function-code-generation)
  - [Stack and Global Variables Management](#stack-and-global-variables-management)
  - [Parameter Passing and Stack Frames](#parameter-passing-and-return-values)
  - [AST Expression Code Generation](#ast-code-generation)
...
- [How to Run the Compiler](#how-to-run-the-compiler)
  ...
  - [Testing](#testing)
  - [Output](#output)
- [VeSPA Simulator](#vespa-simulator)
- [VeSPA Assembler](#vespa-assembler)
...
<table>
  <tr>
    <td align="center" valign="middle" width="50%">
      <img src="Images/CGenTemplateIF1.png" alt="IF Tree" width="85%">
    </td>
    <td align="center" valign="middle" width="50%">
